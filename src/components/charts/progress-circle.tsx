...
const progressCircleVariants = tv({
  ...
  variants: {
    variant: {
      default: {
        background: 'stroke-(--blue-3)',
        circle: 'stroke-(--blue-9)',
      },
      neutral: {
        background: 'stroke-(--color-gray-3)',
        circle: 'stroke-(--color-gray-9)',
      },
      warning: {
        background: 'stroke-(--yellow-3)',
        circle: 'stroke-(--yellow-9)',
      },
      error: {
        background: 'stroke-(--red-3)',
        circle: 'stroke-(--red-9)',
      },
      success: {
